...
namespace Node.Net
{
    public class Element :  INotifyPropertyChanged, IElement
    {
        ...
        */
        ...
        {
            get { return Node.Net.Collections.ObjectExtension.GetParent(this); }
            set { Node.Net.Collections.ObjectExtension.SetParent(this, value); }
        }
        public void DeepUpdateParents()
        {
            Node.Net.Collections.IDictionaryExtension.DeepUpdateParents(this);
        }
