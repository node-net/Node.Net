...
namespace Node.Net.Controls
{
    ...
    class TreeViewItem_Test
    {
        ...
        {
            NUnit.Framework.Assert.False(Json.KeyValuePair.IsKeyValuePair("abc"));
            NUnit.Framework.Assert.True(Json.KeyValuePair.IsKeyValuePair(new System.Collections.Generic.KeyValuePair<string, dynamic>("string", "abc")));
        }
        ...
        {
            string s = "abc";
            NUnit.Framework.Assert.AreSame(s, Json.KeyValuePair.GetValue(s));
            ...
            NUnit.Framework.Assert.AreSame(kvp.Value, Json.KeyValuePair.GetValue(kvp));
        }
        [TestCase]
        ...
        public void TreeViewItem_Children()
        {
            ...
            NUnit.Framework.Assert.True(Json.KeyValuePair.IsKeyValuePair(children[0]));
            NUnit.Framework.Assert.AreEqual("childHash", Json.KeyValuePair.GetKey(children[0]));
            NUnit.Framework.Assert.AreSame(childHash, Json.KeyValuePair.GetValue(children[0]));
            NUnit.Framework.Assert.AreEqual("childArray", Json.KeyValuePair.GetKey(children[1]));
        }
