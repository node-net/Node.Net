...
namespace Node.Net.Model3D
{
    public class Transform3DHelper
    {
        ...
        private void SetTransformMetaData(IDictionary dictionary)
        {
            ...
            Node.Net.Model3D.Transform3D transform3D = new Node.Net.Model3D.Transform3D();
            Vector3D translation = Node.Net.Model3D.RenderHelper.GetTranslationMeters(dictionary);
            ...
            object parent = MetaData.GetMetaData(dictionary, "Parent");
            if (!object.ReferenceEquals(null, parent))
            {
                Node.Net.Model3D.Transform3D parentTransform = MetaData.GetMetaData(parent, "Transform3D") as Node.Net.Model3D.Transform3D;
