...
namespace Node.Net
{
    public static class IDictionaryExtension
    {
        ...
        public static IDictionary Copy(this IDictionary dictionary, IDictionary source, Func<object, bool> filterFunction) => Beta.Internal.IDictionaryExtension.Copy(dictionary, source, filterFunction);
