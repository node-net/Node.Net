...
{
    public sealed class ILengthHelper
    {
        public static ILength FromString(string source)
        {
            return new ConcreteLength { Length = GetDouble(source) };
        }
        ...
        class ConcreteLength : ILength { public double Length { get; set; } }
    }
}
