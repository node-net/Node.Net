...
namespace Node.Net.Json
{
    ...
    class Traverser_Test
    {
        ...
        public void Traverser_Usage()
        {
            ...
            Hash hash = new Hash(assembly.GetManifestResourceStream("Node.Net.Node.Net.Json.Traverser.Test.Tree.json"));
            ...
            hash = new Hash(assembly.GetManifestResourceStream("Node.Net.Node.Net.Json.Traverser.Test.Tree.2.json"));
