...
namespace Node.Net.Test
{
    internal static class QuaternionTests
    {
        ...
        [Test]
        public static async Task Constructor_WithValues_InitializesCorrectly()
        {
        ...
        [Test]
        public static async Task Constructor_FromAxisAngle_ZeroAngle_CreatesIdentity()
        {
        ...
        [Test]
        public static async Task Constructor_FromAxisAngle_90DegreesAroundZ_CreatesCorrectQuaternion()
        {
        ...
        [Test]
        public static async Task Constructor_FromAxisAngle_ZeroAxis_CreatesIdentity()
        {
        ...
        [Test]
        public static async Task Properties_GetAndSet_WorkCorrectly()
        {
            Quaternion q = new Quaternion();
            q.X = 1.0;
            q.Y = 2.0;
        ...
        [Test]
        public static async Task Normalize_UnitQuaternion_RemainsUnit()
        {
        ...
        [Test]
        public static async Task Normalize_NonUnitQuaternion_NormalizesCorrectly()
        {
        ...
        [Test]
        public static async Task Normalize_ZeroQuaternion_SetsToNaN()
        {
        ...
        [Test]
        public static async Task Conjugate_NegatesXYZ_KeepsW()
        {
            Quaternion q = new Quaternion(1.0, 2.0, 3.0, 4.0);
        ...
        [Test]
        public static async Task Conjugate_ModifiesInPlace()
        {
            Quaternion q = new Quaternion(1.0, 2.0, 3.0, 4.0);
        ...
        [Test]
        public static async Task Invert_UnitQuaternion_ReturnsConjugate()
        {
            Quaternion q = new Quaternion(0.0, 0.0, 0.707107, 0.707107);
            q.Normalize();
        ...
        [Test]
        public static async Task Invert_ZeroQuaternion_ThrowsException()
        {
            Quaternion q = new Quaternion(0.0, 0.0, 0.0, 0.0);
        ...
        [Test]
        public static async Task Multiply_IdentityQuaternions_ReturnsIdentity()
        {
        ...
        [Test]
        public static async Task Multiply_QuaternionWithItsInverse_ReturnsIdentity()
        {
            Quaternion q = new Quaternion(0.0, 0.0, 0.707107, 0.707107);
            q.Normalize();
            Quaternion original = new Quaternion(q.X, q.Y, q.Z, q.W);
        ...
        [Test]
        public static async Task OperatorMultiply_MultipliesCorrectly()
        {
        ...
        [Test]
        public static async Task OperatorEquality_EqualQuaternions_ReturnsTrue()
        {
        ...
        [Test]
        public static async Task OperatorEquality_DifferentQuaternions_ReturnsFalse()
        {
            Quaternion q1 = new Quaternion(1.0, 2.0, 3.0, 4.0);
            Quaternion q2 = new Quaternion(1.0, 2.0, 3.0, 5.0);
            
            await Assert.That(q1 == q2, Is.False);
        }

        [Test]
        public static async Task OperatorInequality_EqualQuaternions_ReturnsFalse()
        {
            Quaternion q1 = new Quaternion(1.0, 2.0, 3.0, 4.0);
            Quaternion q2 = new Quaternion(1.0, 2.0, 3.0, 4.0);
        ...
        public static async Task Equals_WithDifferentValues_ReturnsFalse()
        {
            ...
            await Assert.That(q1.Equals(q2), Is.False);
        }
        ...
        public static async Task Equals_WithNull_ReturnsFalse()
        {
            ...
            await Assert.That(q.Equals(null), Is.False);
        }

        [Test]
        public static async Task Equals_WithNonQuaternion_ReturnsFalse()
        {
            Quaternion q = new Quaternion(1.0, 2.0, 3.0, 4.0);
            
            await Assert.That(q.Equals("not a quaternion"), Is.False);
        }
        ...
        [Test]
        public static async Task GetHashCode_DifferentValues_ReturnsDifferentHashCode()
        {
            Quaternion q1 = new Quaternion(1.0, 2.0, 3.0, 4.0);
            Quaternion q2 = new Quaternion(1.0, 2.0, 3.0, 5.0);
        ...
        public static async Task ToString_ReturnsFormattedString()
        {
            ...
            await Assert.That(result, Does.Contain("1.5"));
            await Assert.That(result, Does.Contain("2.5"));
            await Assert.That(result, Does.Contain("3.5"));
            await Assert.That(result, Does.Contain("4.5"));
        }

        [Test]
        public static async Task Constructor_FromAxisAngle_180Degrees_CreatesCorrectQuaternion()
        {
        ...
        [Test]
        public static async Task Constructor_FromAxisAngle_NormalizesAxis()
        {
