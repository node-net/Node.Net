...
namespace Node.Net.Test
{
    internal class Vector3DTests
    {
        ...
        [Test]
        public async Task Length_ZeroVector_ReturnsZero()
        {
        ...
        [Test]
        public async Task Add_StaticMethod_ReturnsCorrectResult()
        {
        ...
        [Test]
        public async Task Subtract_StaticMethod_ReturnsCorrectResult()
        {
        ...
        [Test]
        public async Task Multiply_VectorByScalar_ReturnsCorrectResult()
        {
            Vector3D vector = new Vector3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task Multiply_ScalarByVector_ReturnsCorrectResult()
        {
            Vector3D vector = new Vector3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task Divide_VectorByScalar_ReturnsCorrectResult()
        {
        ...
        [Test]
        public async Task DotProduct_PerpendicularVectors_ReturnsZero()
        {
        ...
        [Test]
        public async Task CrossProduct_IsAntiCommutative()
        {
            Vector3D v1 = new Vector3D(1.0, 2.0, 3.0);
            Vector3D v2 = new Vector3D(4.0, 5.0, 6.0);
        ...
        [Test]
        public async Task AngleBetween_ParallelVectors_ReturnsZero()
        {
            Vector3D v1 = new Vector3D(1.0, 0.0, 0.0);
        ...
        [Test]
        public async Task AngleBetween_IdenticalVectors_ReturnsZero()
        {
            Vector3D v1 = new Vector3D(1.0, 0.0, 0.0);
        ...
        [Test]
        public async Task AngleBetween_PerpendicularVectors_ReturnsNinety()
        {
            Vector3D v1 = new Vector3D(1.0, 0.0, 0.0);
            Vector3D v2 = new Vector3D(0.0, 1.0, 0.0);
            double angle = Vector3D.AngleBetween(v1, v2);
        ...
        [Test]
        public async Task AngleBetween_OppositeVectors_ReturnsOneEighty()
        {
            Vector3D v1 = new Vector3D(1.0, 0.0, 0.0);
            Vector3D v2 = new Vector3D(-1.0, 0.0, 0.0);
            double angle = Vector3D.AngleBetween(v1, v2);
        ...
        [Test]
        public async Task Operator_Addition_WorksCorrectly()
        {
            Vector3D v1 = new Vector3D(1.0, 2.0, 3.0);
            Vector3D v2 = new Vector3D(4.0, 5.0, 6.0);
        ...
        [Test]
        public async Task Operator_Subtraction_WorksCorrectly()
        {
            Vector3D v1 = new Vector3D(5.0, 7.0, 9.0);
            Vector3D v2 = new Vector3D(1.0, 2.0, 3.0);
            Vector3D result = v1 - v2;
        ...
        [Test]
        public async Task Operator_MultiplyVectorByScalar_WorksCorrectly()
        {
            Vector3D vector = new Vector3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task Operator_MultiplyScalarByVector_WorksCorrectly()
        {
            Vector3D vector = new Vector3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task Operator_Division_WorksCorrectly()
        {
            Vector3D vector = new Vector3D(2.0, 4.0, 6.0);
            Vector3D result = vector / 2.0;
            await Assert.That(result.X).IsEqualTo(1.0);
        ...
        [Test]
        public async Task Operator_UnaryNegation_WorksCorrectly()
        {
            Vector3D vector = new Vector3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task Operator_Equality_ReturnsTrueForEqualVectors()
        {
            Vector3D v1 = new Vector3D(1.0, 2.0, 3.0);
            Vector3D v2 = new Vector3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task Operator_Equality_ReturnsFalseForDifferentVectors()
        {
            Vector3D v1 = new Vector3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task Operator_Inequality_ReturnsTrueForDifferentVectors()
        {
            Vector3D v1 = new Vector3D(1.0, 2.0, 3.0);
            Vector3D v2 = new Vector3D(1.0, 2.0, 4.0);
            await Assert.That(v1 != v2).IsTrue();
        ...
        [Test]
        public async Task Operator_Inequality_ReturnsFalseForEqualVectors()
        {
            Vector3D v1 = new Vector3D(1.0, 2.0, 3.0);
            Vector3D v2 = new Vector3D(1.0, 2.0, 3.0);
            await Assert.That(v1 != v2).IsFalse();
        ...
        [Test]
        public async Task Equals_WithEqualVector_ReturnsTrue()
        {
            Vector3D v1 = new Vector3D(1.0, 2.0, 3.0);
            Vector3D v2 = new Vector3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task Equals_WithDifferentVector_ReturnsFalse()
        {
            Vector3D v1 = new Vector3D(1.0, 2.0, 3.0);
            Vector3D v2 = new Vector3D(1.0, 2.0, 4.0);
        ...
        [Test]
        public async Task Equals_WithNonVector_ReturnsFalse()
        {
            Vector3D v1 = new Vector3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task Parse_WithoutParentheses_ParsesCorrectly()
        {
        ...
        [Test]
        public async Task Parse_WithParentheses_ThrowsFormatException()
        {
        ...
        [Test]
        public async Task Parse_WithParentheses_ExactRochambeauFormat_ThrowsFormatException()
        {
        ...
        [Test]
        public async Task Parse_WithParentheses_OnlyOpeningParenthesis_Fails()
        {
        ...
        [Test]
        public async Task Parse_WithParentheses_OnlyClosingParenthesis_Fails()
        {
        ...
        [Test]
        public async Task Parse_WithParentheses_MismatchedParentheses_Fails()
        {
        ...
        [Test]
        public async Task Parse_WithParentheses_ReversedParentheses_Fails()
        {
        ...
        [Test]
        public async Task Parse_WithParentheses_ExtraContentAfterParentheses_Fails()
        {
        ...
        [Test]
        public async Task Parse_WithParentheses_ExtraContentBeforeParentheses_Fails()
        {
