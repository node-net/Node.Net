...
namespace Node.Net.Test
{
    internal class Size3DTests
    {
        ...
        [Test]
        public async Task OperatorEquals_EqualSizes_ReturnsTrue()
        {
        ...
        [Test]
        public async Task OperatorNotEquals_DifferentSizes_ReturnsTrue()
        {
            Size3D s1 = new Size3D(1.0, 2.0, 3.0);
        ...
        [Test]
        public async Task GetHashCode_EqualSizes_ReturnSameHashCode()
        {
            Size3D s1 = new Size3D(1.0, 2.0, 3.0);
            Size3D s2 = new Size3D(1.0, 2.0, 3.0);
