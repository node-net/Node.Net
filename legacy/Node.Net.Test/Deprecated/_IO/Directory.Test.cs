...
namespace Node.Net._IO
{
    ...
    class Directory_Test
    {
        ...
        {
            var directory = System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData) + @"\tmp\LEP.IO.Directory_Test\Directory_Glob";
            var directoryDictionary = new System.Collections.Generic.Dictionary<string, object>();
            ...
            var names = Directory.Glob(directory, "*.txt");
        ...
        {
            var directory = System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData) + @"\tmp\LEP.IO.Directory_Test\Directory_Zip";
            ...
            var zipfile = System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData) + @"\tmp\LEP.IO.Directory_Test\Directory_Zip.zip";
