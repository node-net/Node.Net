...
namespace Node.Net
{
	...
	public class FactoryTest
	{
		...
		public void ClearCache()
		{
			...
			factory.Cache = false;
			factory.ClearCache(DateTime.Now);
			factory.Cache = true;
			factory.ClearCache(DateTime.Now);
		}
		[Test]
	   ...
	   public void Factory_Create_Abstract()
		{
			...
			Assert.NotNull(factory.AbstractTypes, "factory.AbstractTypes");
			Assert.NotNull(factory.DefaultObjectType, "factory.DefaultObjectType");
			Assert.NotNull(factory.FactoryFunctions, "factory.FactoryFunctions");
			Assert.NotNull(factory.Model3DCache, "factory.Model3DCache");
			Assert.NotNull(factory.Model3DIgnoreTypes, "factory.Model3DIgnoreTypes");
		}
		...
		[Test]
		public void Factory_Assembly_Constructor()
		{
		...
		[Test]
		public void GetScalingTransform()
		{
			Factory.GetScalingTransform(new Dictionary<string, dynamic>());
			Factory.GetScalingTransform(null);
		}
	}
}
