...
namespace Node.Net.Test
{
    ...
    internal class Matrix3DDiagnosticTest
    {
        ...
        public void CaptureWindowsBehavior()
        {
            ...
            System.Console.WriteLine($"Windows Quaternion(0,0,1, 15): X={q1.X}, Y={q1.Y}, Z={q1.Z}, W={q1.W}");
            System.Console.WriteLine($"Windows Matrix after Rotate: M11={m1.M11}, M12={m1.M12}, M13={m1.M13}");
            System.Console.WriteLine($"Windows Transform(1,0,0): X={result1.X}, Y={result1.Y}, Z={result1.Z}");
            ...
            System.Console.WriteLine($"Windows Translate then Rotate: Point={p2a.X}, {p2a.Y}, {p2a.Z}");
            
            // Test 3: RotateOTS behavior
            Matrix3D m3 = new Matrix3D();
            m3.RotateOTS(new Vector3D(15, 0, 0));
            Vector3D xvec3 = m3.Transform(new Vector3D(1, 0, 0));
            System.Console.WriteLine($"Windows RotateOTS(15,0,0) Transform(1,0,0): X={xvec3.X}, Y={xvec3.Y}, Z={xvec3.Z}");
        }
    }
}
#endif
