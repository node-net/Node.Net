...
{
    [TestFixture,Category("Json"),Category("HashBase")]
    class HashBase_Test
    {
        [TestCase,Category("Json"),Category("HashBase")]
        ...
        public void HashBase_Stream_Constructor()
        {
            ...
            HashBase hash = new HashBase(assembly.GetManifestResourceStream("Node.Net.Json.Hash_Test.Sample.json"));
