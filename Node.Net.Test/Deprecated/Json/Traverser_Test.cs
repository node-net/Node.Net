...
{
    [TestFixture,Category("Json"),Category("Traverser")]
    class Traverser_Test
    {
        ...
        public void Traverser_Usage()
        {
            ...
            Hash hash = new Hash(assembly.GetManifestResourceStream("Node.Net.Json.Traverser_Test.Tree.json"));
            ...
            hash = new Hash(assembly.GetManifestResourceStream("Node.Net.Json.Traverser_Test.Tree.2.json"));
